...
if __name__ == '__main__':
    data = pd.read_excel('ADCcode.xlsx', parse_dates=True)
    ...
    dataX = pd.read_excel('ADCcode.xlsx', index_col="date", parse_dates=True)
    ...
    history = model.fit(train_X, train_Y, validation_data=(test_X, test_Y), epochs=40, batch_size=40, verbose=1,
                        shuffle=True)
